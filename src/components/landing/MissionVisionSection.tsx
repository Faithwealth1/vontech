  ...
  return (
    <section className="justify-center items-stretch z-0 flex w-full flex-col overflow-hidden text-center bg-white pt-[60px] pb-[120px] px-20 max-md:max-w-full max-md:pb-[100px] max-md:px-5">
      <div className="flex w-full items-center gap-[40px_80px] justify-center flex-wrap max-md:max-w-full">
        <article className="self-stretch flex min-w-60 flex-col w-[350px] my-auto items-center text-center">
          <h2 className="text-4xl font-bold leading-none text-[#097484]">
            Vision
          </h2>
        ...
        <div className="aspect-[0.01] object-contain w-px stroke-[1px] stroke-[#E0E0E0] self-stretch shrink-0 my-auto border-l border-[#E0E0E0] max-md:hidden" />
        <article className="self-stretch flex min-w-60 flex-col w-[350px] my-auto items-center text-center">
          <h2 className="text-4xl font-bold leading-none text-[#097484]">
            Mission
          </h2>
